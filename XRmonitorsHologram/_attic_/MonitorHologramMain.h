...
#endif
#include "DesktopDuplication/DesktopRender.hpp"
#include "DesktopDuplication/SpatialInputHandler.h"

// Updates, renders, and presents holographic content using Direct3D.
namespace XRmonitorsHologram
{
    class MonitorHologramMain : public DX::IDeviceNotify
    {
    public:
        MonitorHologramMain(
