...
///Constuctor/Destructor
   ...
   INI(const void* data, size_t dataSize, bool doParse): data((data_t*)data), dataSize(dataSize)
   {
...
///Functions
   ...
   bool parse()
   {
      ...
      case SOURCE_MEMORY: {
            ...
            //sstream.rdbuf()->pubsetbuf((char*)data, dataSize);
            //parse(sstream);
            imemstream mstream(data, dataSize);
            parse(mstream);
        }
         break;
      }
